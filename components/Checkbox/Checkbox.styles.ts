export const styles = {
  base: 'absolute w-full h-full bg-white border border-gray-300 transition-colors transition-transform duration-100 peer-checked:scale-0 peer-disabled:cursor-not-allowed peer-disabled:bg-gray-100',
  containerSizes: {
    xs: 14,
    sm: 16,
    md: 20,
